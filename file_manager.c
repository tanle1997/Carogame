...
extern void writeData(struct Player *p, struct Player *pl)
{
  ...
  if(1u == m_Pl1)    // neu nguoi choi 1 la nguoi choi cu
  {
    ...
    (p + m_Add1)->rating = (float)pl->win/(float)(\
      pl->win + pl->draw + pl->lose);
  }
  if(1u == m_Pl2)    // neu nguoi choi 2 la nguoi choi cu
  {
    ...
    (p + m_Add2)->rating = (float)(pl + 1u)->win/(float)((pl + 1u)->win + \
  ...
  if((0 == m_Pl1) && (0 == m_Pl2))    // neu hai nguoi choi la nguoi choi moi
  {
    ...
    (p + m_oldPerson)->rating = (float)pl->win/(float)(pl->win + pl->draw + \
      pl->lose);
    ...
    (p + m_oldPerson + 1u)->rating = (float)(pl + 1u)->win/((float)(
  ...
  {   // neu chi co mot nguoi choi moi
    ...
    else if((1u == m_Pl1) && (0 == m_Pl2))
    {
      ...
      (p + m_oldPerson)->rating = (float)(pl + 1u)->win/(float)(\
